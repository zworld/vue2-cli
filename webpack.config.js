...
let config = {
    ...
    output: {
        ...
        // publicPath: "/web-cli-websec/web/app/",
        filename: "js/[name].js",
    ...
    module: {
        ...
        loaders: [
            ...
            // {
            //     test: /\.css$/,
            //     loader: CSSExtractPlugin.extract("style-loader", "css!autoprefixer")
            // },
            //.less 文件想要编译，scss就需要这些东西！来编译处理
            //install css-loader style-loader less-loader --save-dev
            // {
            //     test: /\.less$/,
            //     loader: CSSExtractPlugin.extract("style-loader", "css!autoprefixer!less")
            // },
